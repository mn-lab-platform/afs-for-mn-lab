 ...
 */
(self["webpackChunkafs_plocal"] = self["webpackChunkafs_plocal"] || []).push([["opt_venv_lib_python3_13_site-packages_arches_app_media_js_views_rdm_concept-report_js-opt_ven-d283e9"],{
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! models/concept */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/concept.js\"), __webpack_require__(/*! models/value */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/value.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Backbone, ConceptModel, ValueModel) {\n  return Backbone.View.extend({\n    initialize: function initialize(e) {\n      var self = this;\n      this.modal = this.$el.find('.modal');\n      this.modal.on('hidden.bs.modal', function () {\n        self.$el.find('input[type=text], textarea').val('');\n      });\n      this.select2 = this.$el.find('[name=language_dd]').select2({\n        minimumResultsForSearch: -1\n      });\n      this.modal.validate({\n        ignore: null,\n        rules: {\n          label: 'required',\n          language_dd: 'required',\n          scheme_group_dd: 'required'\n        },\n        submitHandler: function submitHandler(form) {\n          var label = new ValueModel({\n            value: $(form).find('[name=label]').val(),\n            language: $(form).find('[name=language_dd]').val(),\n            category: 'label',\n            type: 'prefLabel'\n          });\n          var collection = new ConceptModel({\n            legacyoid: $(form).find('[name=label]').val(),\n            values: [label],\n            nodetype: 'Collection'\n          });\n          self.modal.on('hidden.bs.modal', function (e) {\n            collection.save(function (response, status) {\n              self.trigger('collectionAdded', response.responseJSON);\n            }, self);\n          });\n          self.modal.modal('hide');\n          return false;\n        }\n      });\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/add-collection-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! dropzone */ \"./node_modules/dropzone/dist/min/dropzone-amd-module.min.js\"), __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/src/js.cookie.js\"), __webpack_require__(/*! bootstrap */ \"./node_modules/bootstrap/dist/js/bootstrap.min.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, arches, Backbone, dropzone, Cookies) {\n  return Backbone.View.extend({\n    events: {\n      'click button': 'close'\n    },\n    initialize: function initialize(options) {\n      var self = this,\n        dropzoneEl = this.$el.find('.dropzone'),\n        dropzoneInstance;\n      // detect if dropzone is attached, and if not init\n      if (!dropzoneEl.hasClass('dz-clickable')) {\n        dropzoneInstance = new dropzone(dropzoneEl[0], {\n          url: arches.urls.concept.replace('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', this.model.get('id')),\n          acceptedFiles: 'image/*',\n          headers: {\n            'X-CSRFToken': Cookies.get('csrftoken')\n          }\n        });\n        dropzoneInstance.on(\"addedfile\", function (file) {\n          self.changed = true;\n        });\n      }\n      this.$el.find('.modal').modal('show');\n    },\n    close: function close() {\n      var self = this,\n        modal = this.$el.find('.modal');\n      if (this.changed) {\n        modal.on('hidden.bs.modal', function () {\n          self.trigger('dataChanged');\n        });\n      }\n      modal.modal('hide');\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/add-image-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\"), __webpack_require__(/*! models/concept */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/concept.js\"), __webpack_require__(/*! models/value */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/value.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Backbone, arches, ConceptModel, ValueModel) {\n  return Backbone.View.extend({\n    initialize: function initialize(options) {\n      var self = this;\n      this.modal = this.$el.find('.modal');\n      this.viewModel = options.viewModel;\n\n      // test to see if select2 has already been applied to the dom\n      if (!this.$el.find('.select2').attr('id')) {\n        this.schemedropdown = this.$el.find('.select2').select2({\n          placeholder: arches.translations.selectAnOption\n        }).on(\"select2:selecting\", function (e) {\n          $.ajax({\n            url: arches.urls.confirm_delete.replace('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', e.params.args.data.id),\n            success: function success(response) {\n              self.modal.find('.modal-body [name=\"additional-info\"]').html(response);\n            }\n          });\n        });\n      }\n      this.modal.validate({\n        ignore: null,\n        rules: {\n          scheme_dd: \"required\"\n        },\n        submitHandler: function submitHandler(form) {\n          self.viewModel.loading(true);\n          self.model = new ConceptModel({\n            'id': self.schemedropdown.val(),\n            'nodetype': 'ConceptScheme',\n            'delete_self': true\n          });\n          self.model.delete(function () {\n            self.modal.modal('hide');\n            self.viewModel.loading(true);\n            self.trigger('conceptSchemeDeleted');\n          }, self);\n        }\n      });\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/delete-scheme-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\"), __webpack_require__(/*! models/value */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/value.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Backbone, arches) {\n  return Backbone.View.extend({\n    initialize: function initialize(e) {\n      if (!this.rendered) {\n        this.render();\n      }\n    },\n    render: function render() {\n      var self = this;\n      this.rendered = true;\n      this.modal = this.$el.find('.modal');\n\n      // test to see if select2 has already been applied to the dom\n      if (!this.$el.find('.select2').attr('id')) {\n        this.schemedropdown = this.$el.find('.select2').select2({\n          placeholder: arches.translations.selectAnOption\n        });\n      }\n      this.modal.validate({\n        ignore: null,\n        rules: {\n          scheme_dd: \"required\"\n        },\n        submitHandler: function submitHandler(form) {\n          var scheme = $(form).find(\"[name=scheme_dd]\").val();\n          window.open(arches.urls.export_concept.replace('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', scheme), '_blank');\n          self.modal.modal('hide');\n        }\n      });\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/export-scheme-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Backbone, arches) {\n  return Backbone.View.extend({\n    initialize: function initialize(options) {\n      var self = this;\n      this.modal = this.$el.find('.modal');\n      this.viewModel = options.viewModel;\n      this.select2 = this.$el.find('[name=language_dd]').select2({\n        minimumResultsForSearch: -1\n      });\n      this.modal.validate({\n        ignore: null,\n        rules: {\n          skosfile: \"required\",\n          overwrite_options: \"required\"\n        },\n        submitHandler: function submitHandler(form) {\n          var data = new FormData(form);\n          self.viewModel.loading(true);\n          $.ajax({\n            url: arches.urls.concept.replace('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', ''),\n            type: 'POST',\n            data: data,\n            processData: false,\n            contentType: false,\n            complete: function complete(response, status) {\n              self.modal.modal('hide');\n              self.viewModel.loading(false);\n              self.trigger('conceptSchemeAdded', response, status);\n            }\n          });\n          return false;\n        }\n      });\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/import-scheme-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! views/concept-search */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/concept-search.js\"), __webpack_require__(/*! models/concept */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/concept.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, arches, Backbone, ConceptSearch, ConceptModel) {\n  return ConceptSearch.extend({\n    initialize: function initialize() {\n      ConceptSearch.prototype.initialize.apply(this, arguments);\n      var self = this;\n      this.modal = this.$el.find('form');\n      this.relationshiptype = this.modal.find('#related-relation-type').select2({\n        placeholder: arches.translations.selectAnOption,\n        minimumResultsForSearch: 10,\n        maximumSelectionSize: 1\n      });\n      this.modal.validate({\n        ignore: null,\n        rules: {\n          concept_search_box: 'required',\n          relationtype_dd: 'required'\n        },\n        submitHandler: function submitHandler(form) {\n          var relatedConcept = new ConceptModel({\n            id: self.searchbox.val(),\n            relationshiptype: self.relationshiptype.val()\n          });\n          self.model.set('relatedconcepts', [relatedConcept]);\n          self.modal.on('hidden.bs.modal', function (e) {\n            self.model.save();\n          });\n          self.modal.modal('hide');\n        }\n      });\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/related-concept-form.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! backbone */ \"./node_modules/backbone/backbone-min.js\"), __webpack_require__(/*! views/concept-search */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/concept-search.js\"), __webpack_require__(/*! models/concept */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/models/concept.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Backbone, ConceptSearch, ConceptModel) {\n  return ConceptSearch.extend({\n    events: {\n      'click .modal-footer .savebtn': 'save'\n    },\n    initialize: function initialize() {\n      ConceptSearch.prototype.initialize.apply(this, arguments);\n      this.modal = this.$el.find('.modal');\n      this.relationshiptype = this.modal.find('#related-relation-type').select2({\n        minimumResultsForSearch: 10,\n        maximumSelectionSize: 1\n      });\n    },\n    save: function save() {\n      var self = this;\n      if (this.searchbox.val() !== '') {\n        var relatedConcept = new ConceptModel({\n          id: this.searchbox.val(),\n          relationshiptype: this.relationshiptype.val()\n        });\n        this.model.set('relatedconcepts', [relatedConcept]);\n        this.modal.on('hidden.bs.modal', function (e) {\n          self.model.save();\n        });\n        this.modal.modal('hide');\n      }\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/rdm/modals/related-member-form.js?\n}");
