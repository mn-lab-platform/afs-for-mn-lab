 ...
 */
(self["webpackChunkafs_plocal"] = self["webpackChunkafs_plocal"] || []).push([["opt_venv_lib_python3_13_site-packages_arches_app_media_js_views_base-manager_js-node_modules_-dad5f5"],{
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! knockout */ \"./node_modules/knockout/build/output/knockout-latest.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, ko) {\n  // Register binding of onEnterkeyClick. e.g. <div data-bind=\"onEnterkeyClick\"> </div>\n  ko.bindingHandlers.onEnterkeyClick = {\n    init: function init(element, valueAccessor) {\n      ko.utils.unwrapObservable(valueAccessor()); // Unwrap to get subscription.\n      $(element).keypress(function (event) {\n        var keyCode = event.which ? event.which : event.keyCode;\n        if (keyCode === 13) {\n          // Check if keypress is <enter>.\n          $(element).click();\n        }\n        return false; // Allow default action.\n      });\n    }\n  };\n\n  // Register binding of onSpaceClick. e.g. <div data-bind=\"onSpaceClick\"> </div>\n  ko.bindingHandlers.onSpaceClick = {\n    init: function init(element, valueAccessor) {\n      ko.utils.unwrapObservable(valueAccessor()); // Unwrap to get subscription.\n      $(element).keypress(function (event) {\n        var keyCode = event.which ? event.which : event.keyCode;\n        if (keyCode === 32) {\n          // Check if keypress is <space>.\n          $(element).click();\n        }\n        return false; // Allow default action.\n      });\n    }\n  };\n  return;\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/key-events-click.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/src/js.cookie.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, Cookies) {\n  /**\n  * csrfSafeMethod - checks if the request method is CSRF safe (using regex)\n  * this function is called before every request made using jQuery, and\n  * the CSRF token is set accordingly\n  *\n  * @param  {string} the request method name\n  * @return {boolean} true if the method is CSRF safe\n  */\n  function csrfSafeMethod(method) {\n    // these HTTP methods do not require CSRF protection\n    return /^(GET|HEAD|OPTIONS|TRACE)$/.test(method);\n  }\n  $.ajaxSetup({\n    beforeSend: function beforeSend(xhr, settings) {\n      if (!csrfSafeMethod(settings.type) && !this.crossDomain) {\n        xhr.setRequestHeader(\"X-CSRFToken\", Cookies.get('csrftoken'));\n      }\n    }\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/utils/set-csrf-token.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! knockout */ \"./node_modules/knockout/build/output/knockout-latest.js\"), __webpack_require__(/*! templates/views/components/language-switcher.htm */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/templates/views/components/language-switcher.htm\"), __webpack_require__(/*! js-cookie */ \"./node_modules/js-cookie/src/js.cookie.js\"), __webpack_require__(/*! bindings/select2-query */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/select2-query.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (ko, languageSwitcherTemplate, Cookies) {\n  /**\n  * knockout components namespace used in arches\n  * @external \"ko.components\"\n  * @see http://knockoutjs.com/documentation/component-binding.html\n  */\n\n  /**\n  * registers a language-switcher component for use in forms\n  * @function external:\"ko.components\".language-switcher\n  * @param {object} params\n  * @param {string} params.current_language - the currently active language in the application\n  */\n  return ko.components.register('views/components/language-switcher', {\n    viewModel: function viewModel(params) {\n      this.formid = Math.random();\n      this.value = ko.observable(params.current_language);\n      this.csrfToken = Cookies.get('csrftoken');\n      this.value.subscribe(function (val) {\n        if (val) {\n          document.getElementById(this.formid).submit();\n        }\n      }, this);\n    },\n    template: languageSwitcherTemplate\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/components/language-switcher.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.min.js\"), __webpack_require__(/*! arches */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/arches.js\"), __webpack_require__(/*! views/list */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/list.js\"), __webpack_require__(/*! bindings/datepicker */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/datepicker.js\"), __webpack_require__(/*! bindings/chosen */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/chosen.js\"), __webpack_require__(/*! views/components/simple-switch */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/components/simple-switch.js\"), __webpack_require__(/*! views/components/notification */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/components/notification.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($, arches, ListView) {\n  var NotificationsList = ListView.extend({\n    /**\n    * A backbone view to manage a list of notification records\n    * @augments ListView\n    * @constructor\n    * @name NotificationsList\n    */\n\n    singleSelect: true,\n    initialize: function initialize(options) {\n      var self = this;\n      this.items = options.items;\n      this.helploading = options.helploading;\n      ListView.prototype.initialize.apply(this, arguments);\n      this.updateList = function () {\n        self.helploading(true);\n        $.ajax({\n          type: 'GET',\n          url: arches.urls.get_notifications,\n          data: {\n            \"unread_only\": true\n          }\n        }).done(function (data) {\n          self.items(data.notifications);\n          self.helploading(false);\n        });\n      };\n      this.dismissAll = function () {\n        var notifs = self.items().map(function (notif) {\n          return notif.id;\n        });\n        $.ajax({\n          type: 'POST',\n          url: arches.urls.dismiss_notifications,\n          data: {\n            \"dismissals\": JSON.stringify(notifs)\n          }\n        }).done(function () {\n          self.items.removeAll();\n        });\n      };\n    }\n  });\n  return NotificationsList;\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/notifications-list.js?\n}");
