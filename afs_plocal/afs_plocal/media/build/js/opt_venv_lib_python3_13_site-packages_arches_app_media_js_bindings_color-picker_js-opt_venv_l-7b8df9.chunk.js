 ...
 */
(self["webpackChunkafs_plocal"] = self["webpackChunkafs_plocal"] || []).push([["opt_venv_lib_python3_13_site-packages_arches_app_media_js_bindings_color-picker_js-opt_venv_l-7b8df9"],{
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! knockout */ \"./node_modules/knockout/build/output/knockout-latest.js\"), __webpack_require__(/*! templates/views/components/icon-selector.htm */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/templates/views/components/icon-selector.htm\"), __webpack_require__(/*! bindings/key-events-click */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/key-events-click.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (ko, iconSelectorTemplate) {\n  /**\n  * knockout components namespace used in arches\n  * @external \"ko.components\"\n  * @see http://knockoutjs.com/documentation/component-binding.html\n  */\n\n  /**\n  * registers a icon-selector component for use in forms\n  * @function external:\"ko.components\".icon-selector\n  * @param {object} params\n  * @param {observable} params.selectedIconObservable - the currently selected icon\n  * @param {observable} params.iconFilter\n  * @param {array} params.iconList\n  * @param {string} params.label\n  */\n  return ko.components.register('views/components/icon-selector', {\n    viewModel: function viewModel(params) {\n      this.selectedIcon = params.selectedIconObservable;\n      this.iconFilter = params.iconFilter;\n      this.iconList = params.iconList;\n      this.label = params.label;\n    },\n    template: iconSelectorTemplate\n  });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/components/icon-selector.js?\n}");
...
eval("{var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! knockout */ \"./node_modules/knockout/build/output/knockout-latest.js\"), __webpack_require__(/*! underscore */ \"./node_modules/underscore/underscore-min.js\"), __webpack_require__(/*! views/base-manager */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/base-manager.js\"), __webpack_require__(/*! views/graph/graph-base-data */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/graph/graph-base-data.js\"), __webpack_require__(/*! bindings/chosen */ \"../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/bindings/chosen.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (ko, _, BaseManager, data) {\n  /**\n  * A backbone view representing a page in the graph manager workflow.  It\n  * adds some graph manager specfic values to the view model.\n  *\n  * @augments BaseManager\n  * @constructor\n  * @name GraphPageView\n  */\n  var GraphPageView = BaseManager.extend({\n    /**\n    * Creates an instance of GraphPageView, optionally using a passed in\n    * view model\n    *\n    * @memberof GraphPageView.prototype\n    * @param {object} options\n    * @param {object} options.viewModel - an optional view model to be\n    *                 bound to the page\n    * @return {object} an instance of GraphPageView\n    */\n    constructor: function constructor(options) {\n      var self = this;\n      options.viewModel.graphid = ko.observable(data.graphid);\n      BaseManager.apply(this, arguments);\n      options.viewModel.graphid.subscribe(function (graphid) {\n        var re = /\\b[a-f\\d-]{36}\\b/;\n        var newPath = window.location.pathname.replace(re, graphid);\n        self.viewModel.navigate(newPath);\n      });\n      return this;\n    }\n  });\n  return GraphPageView;\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/media/js/views/graph/graph-page-view.js?\n}");
...
eval("{// Module\nvar code = `\n\n<!-- Icon search component-->\n<div class=\"icon-selector\">\n    <!-- Icon Filter -->\n    <div style=\"padding: 10px;\">\n        <div class=\"flex\" style=\"gap: 5px;\">\n            <div>\n                <span data-bind=\"text: label\"></span>\n                <button class=\"btn btn-default btn-icon icon-lg\" tabindex=\"-1\" data-bind=\"css: selectedIcon(), click: function() {}, attr: {'aria-label': selectedIcon()}\" style=\"height: 35px; width: 35px;\"></button>\n            </div>\n    \n            <div>\n                <input type=\"text\" class=\"form-control\" style=\"width: 366px; height: 36px;\" data-bind=\"\n                        attr: {placeholder: \\$root.translations.findAnIcon, 'aria-label': label},\n                        textInput:iconFilter\n                    \">\n            </div>\n    \n            <!-- ko if: iconFilter() !== '' -->\n            <span class=\"clear-search\" tabindex=\"0\" data-bind=\"onEnterkeyClick, onSpaceClick, click: function () { iconFilter(''); },\n                    attr: {'aria-label': \\$root.translations.clearFilter}\n                \">\n                <i class=\"fa fa-times-circle\"></i>\n            </span>\n            <!-- /ko -->\n        </div>\n    </div>\n    \n    <!-- Skip icon content -->\n    <div><a href=\"#skip-over-icons-target\" id=\"skip-over-icons-link\" class=\"skip-content-link\" tabindex=\"0\">Skip icon listbox</a></div>\n\n    <!-- Icon List -->\n    <div class=\"icon-list\" style=\"height: 300px;overflow-y: scroll;padding: 15px;border: 1px solid #e9e9e9;\" role=\"listbox\">\n        <div>\n    \n            <!-- ko foreach: iconList -->\n            <div class=\"col-xs-6 col-md-3 col-sm-4 demo-icon-font\" data-bind=\"css: {'selected': (cssclass === \\$parent.selectedIcon())}, \n                    onEnterkeyClick, onSpaceClick, click: function() { \\$parent.selectedIcon(cssclass) },\n                    attr: {'aria-label': name, role: 'option', tabindex: '0', 'aria-selected': (cssclass === \\$parent.selectedIcon()).toString() },\n                \">\n                <i data-bind=\"css: cssclass\"></i> <span data-bind=\"text: name\"></span>\n            </div>\n            <!-- /ko -->\n    \n        </div>\n    </div>\n\n    <!-- Skip back to icon content -->\n    <div><a href=\"#skip-over-icons-link\" id=\"skip-over-icons-target\" class=\"skip-content-link\" tabindex=\"0\">Skip back to icon listbox</a></div>\n    \n</div>`;\n// Exports\nmodule.exports = code;\n\n//# sourceURL=webpack://afs_plocal/../../opt/venv/lib/python3.13/site-packages/arches/app/templates/views/components/icon-selector.htm?\n}");
